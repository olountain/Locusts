#### Script to process the all simulation runs (in batches).
# This should not need to be run again as all of
# the processed data has been saved as an RDS file as
# can be seen in a commented line below.

# import the functions to produce the summary stats
source("Analysis/R/01_process_data.R")
source("Analysis/R/02_get_summary_stats.R")
